...
namespace Companions
{
    ...
    public static class CompanionChatLibrary
    {
        ...
        {
            return AreaSpecificAwareDialogue.GetRandomBankAwarenessLine(companionInventoryFull);
        }
        ...
        {
            return AreaSpecificAwareDialogue.GetRandomGoblinCaveAwarenessLine();
        }

        /// <summary>Returns a flavour line for ocean awareness.</summary>
        public static string GetRandomOceanAwarenessLine()
        {
            return AreaSpecificAwareDialogue.GetRandomOceanAwarenessLine();
        }
